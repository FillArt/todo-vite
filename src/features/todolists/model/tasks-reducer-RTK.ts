...
export const changeStatusTaskAC = createAction<{ idTodo: string; idTask: string; isDone: boolean }>(
  "todolists/changeStatusTask",
)
export const changeTitleTaskAC = createAction<{ idTodo: string; idTask: string; title: string }>(
  "todolists/changeTitleTask",
)
